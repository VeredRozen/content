    ...
    for pack_dir in dirs:
        ...
        if os.path.isdir(f'{packs_root}/{pack_dir}/TestPlaybooks'):
            ...
            for playbook in test_playbooks:
                shutil.copyfile(f'{playbook_root}/{playbook}',
                                f'{Build.test_pack_target}/test_pack/TestPlaybooks/{playbook}')
    print('make_archive')
    shutil.make_archive(f'{Build.test_pack_target}/test_pack', 'zip', Build.test_pack_target)
    print('rmtree')
    shutil.rmtree(f'{Build.test_pack_target}/test_pack')
    print('done')
